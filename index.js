...
// Define the Gmail API access scopes
const SCOPES = [
...
// Create a Gmail API instance
  ...
  // Retrieve a list of labels from the Gmail account
  const response = await gmail.users.labels.list({
    userId: "me",
  });


  // Function to get unreplied/unseen messages
  ...
  // Main logic to handle unreplied messages
  async function main() {
    ...
    setInterval(async () => {
      ...
      //  Checking if there any gmail that did not get reply
